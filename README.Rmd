...
The goal of `rOpenserver` is to provide an R interface to Petex applications Prosper, GAP and MBAL.



## Installation

You can install the *development* version of `rOpenserver` from  GtiHub with:
...
Set the folder where the Prosper examples are. Use slash `/` or double-backslash `\\` to separate the folder names, otherwise you will get error.
