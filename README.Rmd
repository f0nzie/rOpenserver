...
## Installation
`rOpenserver` is not in [CRAN](https://cran.r-project.org/) yet but in the meantime, you can install it from  GtiHub using the `devtools` package, from the [rOpenserver repository](https://github.com/f0nzie/rOpenserver) with:
